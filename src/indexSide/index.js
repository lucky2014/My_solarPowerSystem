define(function(require, exports, module) {
    ...
    var indexSideApp = {
        rendStationDetail: function(stationId){
            ...
            $(".footer span,.versionRecord h2 a.versionClose").click(function(){
                if($(".versionRecord").hasClass("hide")){
                    $(".versionRecord").removeClass("hide");
                }else{
                    $(".versionRecord").addClass("hide");
                }
            });
        },
    ...
    stationListApp.init(function(stationId){
        clearInterval(timer);
        timer = null;
        indexSideApp.rendStationDetail(stationId);  //根据新电站ID首次渲染电站详情
         //60秒刷新仪表
        
        timer = setInterval(function(){
            indexSideApp.readerGauge(stationId);
        }, 60000);
    });
